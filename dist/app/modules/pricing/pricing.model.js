...
exports.PacketTransaction = exports.PriceHistory = exports.PricingConfig = void 0;
...
const pricingConfigSchema = new mongoose_1.Schema({
    ...
    lastChangedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User' },
...
const packetTransactionSchema = new mongoose_1.Schema({
...
exports.PacketTransaction = (0, mongoose_1.model)('PacketTransaction', packetTransactionSchema);
