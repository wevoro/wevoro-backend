...
exports.runReminders = exports.signItem = exports.startPacket = exports.offerContext = exports.restoreDocument = exports.removeDocument = exports.replaceDocument = exports.pendingCopies = exports.addDocuments = exports.getLibrary = void 0;
...
exports.signItem = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield EsignService.signItem({
        ...
        ip: ((_b = (_a = req.headers['x-forwarded-for']) === null || _a === void 0 ? void 0 : _a.split(',')[0]) === null || _b === void 0 ? void 0 : _b.trim()) || req.ip,
