...
const isPdf = (file) => {
    ...
    let fd;
    try {
        fd = fs_1.default.openSync(file.path, 'r');
        const head = Buffer.alloc(5);
        fs_1.default.readSync(fd, head, 0, 5, 0);
...
const replaceDocument = (agencyId, documentId, file) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isPdf(file)) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, ACCEPTED_TYPES_COPY);
    }
    if (file.size > MAX_FILE_BYTES) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'File is larger than 10 MB — upload a smaller PDF');
    }
    const uploaded = yield (0, bunny_upload_1.uploadFile)(file);
...
const signItem = (params) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        signerName = yield (0, exports.signatureName)(String(packet.caregiver));
        signedFileUrl = yield (0, esign_document_service_1.stampAndStore)({
        ...
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, `We could not apply your signature to "${item.title}". Nothing was signed — please try again, and tell your agency if it keeps failing.`);
    }
